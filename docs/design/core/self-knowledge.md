...
**Note**: Because this is a static string, it must be manually updated when the architecture changes. This is an acceptable trade-off -- architectural changes are infrequent.
