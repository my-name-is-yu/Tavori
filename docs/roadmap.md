...
- コミュニティプラグイン基盤（npmスコープ: `@motiva-plugins/`、Jira DataSource、PagerDuty Notifier）
- プラグイン開発ガイド（`docs/design/plugin-development-guide.md`）
...
| 17 | 外部連携プラグイン拡充（Jira, PagerDuty, 開発ガイド） | 2026-03-20 |
